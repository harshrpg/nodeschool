...
// file://C:\Users\harsh\AppData\Roaming\npm\node_modules\learnyounode\node_apidoc\net.html
...
/**
 * » Create a TCP server
 * 1. require in the "net" module
 */
const net = require("net");
const strftime = require("strftime");
const server = net.createServer(function(c) {
  // This is the connection listener
  // "socket" is the socket for the connection listener
  // socket.end sends the server a FIN packet and anything within it is executed
  c.end(printData() + "\n");
});
